...
import { createProduct, createProductClicks, createProductView, deleteProducts, getMyProducts, getMyProductsAnalytics, getProductStats,  } from "../controllers/product.controller";
...
productRouter.get("/allstats", authenticate, getMyProductsAnalytics)
