        ...
        <div>
            ...
            <div className="p-10 2xl:p-20 text-center bg-[url('../../../images/CTA-bg.avif')] bg-cover bg-center h-auto 2xl:h-[50vh] flex justify-center items-center flex-col text-white">
                ...
                <div className="flex justify-center gap-4 flex-wrap">
                    <button className="bg-white text-orange text-sm  font-semibold px-5 2xl:px-8 py-2 2xl:py-3 rounded-sm hover:bg-gray-100 transition duration-300">
                        Get Started Free
                    </button>
                    <button className="border-2 border-white text-sm  text-white font-semibold px-5 2xl:px-8 py-2 2xl:py-3 rounded-sm transition duration-300">
                        See How It Works
                    </button>
                </div>
            </div>
